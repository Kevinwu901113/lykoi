 ...
 * | 对话面账 | `inbound/*`、`converse/*`、`u3_cycle_*`、`turn/*`、`continuation/*`、`inner_outer_pair` | D-08 | 否（只记长度/哈希；正文归 history 表 = 她的记忆） |
...
export const CONVERSATION_FACING_PREFIXES: readonly string[] = Object.freeze([
  'inbound/', // WO-TURN-01：durable accept 正本（ID/hash/count，无正文）
  'converse/',
  'u3_cycle_',
