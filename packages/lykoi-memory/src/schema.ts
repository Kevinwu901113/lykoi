...
export const STATE_SCHEMA_DDL = `
    ...
    -- WO-TURN-01（mind_schema 19）：外界消息的 durable accept 与 UserTurn 正本。
    -- inbound_parts 保留逐条原文、平台边界、来源时序与 reply attribution；
    -- user_turns 只保存组装/执行状态，不把 parts join 后的字符串另立为正本。
